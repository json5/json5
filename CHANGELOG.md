...
- New: To `require` or `import` JSON5 files, use `require('json5/register')` or
  `import 'json5/register'`. Previous versions used `json5/require`, which still
  exists for backward compatibility but is deprecated and will give a warning.
...
[#72]: https://github.com/json5/json5/issues/71
