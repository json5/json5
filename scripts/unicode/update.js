...
async function main() {
  ...
  const ID_Start = regenerate()
    .add(
      require('unicode-10.0.0/General_Category/Uppercase_Letter/code-points'),
    )
    .add(
      require('unicode-10.0.0/General_Category/Lowercase_Letter/code-points'),
    )
    .add(
      require('unicode-10.0.0/General_Category/Titlecase_Letter/code-points'),
    )
