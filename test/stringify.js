...
t.test('JSON5', t => {
  t.test('#stringify', t => {
    t.test('objects', t => {
      t.strictSame(JSON5.stringify({}), '{}', 'stringifies empty objects')
    ...
    t.test('arrays', t => {
      t.strictSame(JSON5.stringify([]), '[]', 'stringifies empty arrays')

      t.strictSame(JSON5.stringify([1]), '[1]', 'stringifies array values')
    ...
    t.strictSame(JSON5.stringify(null), 'null', 'stringifies nulls')
    ...
    t.strictSame(JSON5.stringify({a() {}}), '{}', 'ignores function properties')
    ...
    t.test('Booleans', t => {
      t.strictSame(JSON5.stringify(true), 'true', 'stringifies true')

      t.strictSame(JSON5.stringify(false), 'false', 'stringifies false')
  ...
  t.test('#stringify(value, replacer)', t => {
    ...
    t.strictSame(
      JSON5.stringify({a: {b: 1}}, function (k, v) {
